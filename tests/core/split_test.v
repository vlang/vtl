...
fn test_array_split() {
	a := vtl.seq[f64](9).reshape([3, 3])!
	e1 := vtl.from_array([0.0, 1, 2], [1, 3])!
	e2 := vtl.from_array([3.0, 4, 5], [1, 3])!
	e3 := vtl.from_array([6.0, 7, 8], [1, 3])!
...
fn test_array_split_expl() {
	a := vtl.seq[f64](9).reshape([3, 3])!
	e1 := vtl.from_array([0.0, 3, 6], [3, 1])!
	e2 := vtl.from_array([1.0, 2, 4, 5, 7, 8], [3, 2])!
...
fn test_dsplit() {
	a := vtl.seq[f64](27).reshape([3, 3, 3])!
	result := a.dsplit(3)!
