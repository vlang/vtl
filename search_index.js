...
["datasets","for_each applies `fn` to each batch until exhaustion or `fn` returns false. Retu","datasets.html#DataLoader[T].for_each","fn (DataLoader[T])"],
["datasets","split splits a DataLoader into train and validation DataLoaders. The validation ","datasets.html#DataLoader[T].split","fn (DataLoader[T])"],
...
["datasets","new_data_loader creates a DataLoader from a dataset tensor. The dataset must hav","datasets.html#new_data_loader","fn "],
...
["datasets","next returns the next batch. Returns none when exhausted. Reset the loader betwe","datasets.html#DataLoaderIterator[T].next","fn (DataLoaderIterator[T])"],
